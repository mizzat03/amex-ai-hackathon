...
>(({ className, ...props }, ref) => (
  <RadixTabs.Trigger ref={ref} className={cn("rounded-lg px-3 py-1.5 text-xs font-semibold text-[var(--ink-muted)] outline-none data-[state=active]:bg-[var(--surface)] data-[state=active]:text-[var(--ink)] data-[state=active]:shadow-sm focus-visible:ring-2 focus-visible:ring-[var(--focus)]", className)} {...props} />
));
